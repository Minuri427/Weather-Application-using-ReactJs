...
// const API_key = "f6313b9a2c84e8833fb8c43104192308";
...
class App extends React.Component{
  constructor(){
    ...
    this.weatherIcon={
      ...
      Snow:"wi wi-snow display-1-snow",
  ...
  getWeather = async (e) =>{
    ...
    if(city && country){
      const api_call = await fetch('http://api.openweathermap.org/data/2.5/weather?q='+city+','+country+'&appid=f6313b9a2c84e8833fb8c43104192308');
